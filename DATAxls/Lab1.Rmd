...
Downloaded "DATAxls" and unzipped into LAB1. Then set the working directory by using the code:
```{r directory}
setwd("~/School/Junior Year/Spring/Applied Statistical Methods/Labs/LAB1/DATAxls")
```
